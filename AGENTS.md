...
npm run signal -w @gapline/agent                              # print BTC signal + belief (pre-flight)
...
- Robinhood Chain supports Stylus (Arbitrum Orbit). Uniswap is live on mainnet and stock-token pools trade 24/7
  (pool depth for TSLA not yet measured).
