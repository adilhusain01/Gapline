...
| `apps/web` | Market and Borrow pages; stock picker in the header (zustand `stock`) | TanStack Router + Query, wagmi 3 (injected connector), shadcn/ui (radix-nova), zustand, Tailwind v4 |
